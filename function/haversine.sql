...
-- https://rosettacode.org/wiki/Haversine_formula#MySQL
-- Gets the distance (in miles) between two latitude/longitude coordinates (in degrees).
DELIMITER $$
CREATE FUNCTION haversine(lat1 FLOAT, lon1 FLOAT,
						  lat2 FLOAT, lon2 FLOAT) RETURNS FLOAT
	NO SQL DETERMINISTIC
BEGIN
	DECLARE r FLOAT unsigned DEFAULT 3963;
